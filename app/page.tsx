...
const ToDelete = () => {
  return (
    <main className="space-y-6">
      <Prose>
        <h1>
          <Balancer>Headless WordPress built with the Next.js for SPM</Balancer>
        </h1>

        <p>
          This is <a href="">next-wp</a>,
          created as a way to build WordPress sites with Next.js.
          This  is designed with{" "}
